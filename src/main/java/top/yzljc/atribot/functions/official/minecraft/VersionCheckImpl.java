...
public final class VersionCheckImpl {
    ...
    public static void onCommand(CommandSender sender, String label) {
    ...
    private static void pushUpdateInfo(VersionType type, VersionInfo versionInfo) {
        ...
        Set<Long> groups = GroupInformation.fetchAllGroupIds();
        List<String> officialGroups = GroupList.enabledGroups("mc_news");
