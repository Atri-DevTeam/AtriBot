...
import top.yzljc.atribot.feature.like.LikeUserListRecord;
...
public class BedwarsChallenge implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if ("api".equalsIgnoreCase(args[0])) {
            ...
            LikeUserListRecord.saveBwcApiKey(key);
        ...
        String apiKey = LikeUserListRecord.loadBwcApiKey();
        if (apiKey.isEmpty()) {
...
//            String displayName = mojangResp.has("name") ? mojangResp.path("name").asText() : playerName;
            ...
            result.add(GroupMessage.createTextNode(out.toString()));
