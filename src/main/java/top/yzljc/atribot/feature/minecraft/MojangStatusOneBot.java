...
import top.yzljc.atribot.service.image.AbstractImage;
...
@Deprecated
public class MojangStatusOneBot implements CommandExecutor {

    private static final Logger log = LoggerFactory.getLogger(MojangStatusOneBot.class);
