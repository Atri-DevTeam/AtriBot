package top.yzljc.atribot.feature.like;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        switch (sub) {
            case "add" -> {
                ...
                sender.reply("已将 " + UserInformation.getUserName(targetUid) + "(" + targetUid + ") 加入自动点赞列表", false);
                return true;
            }
            case "remove" -> {
                long targetUid;
                ...
                sender.reply("已将 " + UserInformation.getUserName(targetUid) + "(" + targetUid + ") 从自动点赞列表移除", false);
                return true;
            }
            case "list" -> {
                ...
                String oneLine = list.stream()
                        .map(uid -> {
                            String name = UserInformation.getUserName(uid);
