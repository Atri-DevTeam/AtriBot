...
public class C2CRepository {
    ...
    private static final String TABLE = "official_users";
    ...
    private static void migrateFromLegacyTable() {
        try (var con = DatabaseManager.getConnection()) {
            ...
            String migrateSql = "INSERT IGNORE INTO `" + TABLE + "` (user_openId, role, permissions) " +
    ...
    public static boolean upsert(String userOpenId, String role, String permissions) {
        String sql = "INSERT INTO `" + TABLE + "` (user_openId, role, permissions) VALUES (?, ?, ?) " +
    ...
    public static boolean setBlocked(String userOpenId, boolean blocked) {
        String sql = "INSERT INTO `" + TABLE + "` (user_openId, role, permissions, is_blocked) " +
                "VALUES (?, 'USER', '', ?) " +
    ...
    public static boolean setIgnored(String userOpenId, boolean ignored) {
        String sql = "INSERT INTO `" + TABLE + "` (user_openId, role, permissions, is_ignored) " +
                "VALUES (?, 'USER', '', ?) " +
    ...
    public static boolean delete(String userOpenId) {
        String sql = "DELETE FROM `" + TABLE + "` WHERE user_openId = ?";
