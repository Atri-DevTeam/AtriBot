...
public class DefaultTaskSchedule implements TaskSchedule {
    ...
    public DefaultTaskSchedule() {
    }

    public DefaultTaskSchedule(ScheduleMode mode) {
        setMode(mode);
    }

    public DefaultTaskSchedule(ScheduleMode mode, LocalTime time) {
        setMode(mode);
        setTime(time);
    }
