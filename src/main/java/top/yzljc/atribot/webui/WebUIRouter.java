...
public class WebUIRouter {
    ...
    public static void register(Javalin server) {
        ...
        server.post("/webui/api/join-welcome/test", JoinWelcomeController::sendTest);
        ...
        server.get("/webui/api/groups/{groupOpenId}/members/{memberOpenId}", GroupController::getGroupMemberInfo);
        server.post("/webui/api/groups/{groupOpenId}/members/{memberOpenId}/remove", GroupController::removeGroupMember);
        server.get("/webui/api/groups/{groupOpenId}/mute-state", GroupController::getGroupMuteState);
        server.get("/webui/api/groups/{groupOpenId}/member-blacklist", GroupController::getGroupMemberBlacklist);
        server.post("/webui/api/groups/{groupOpenId}/member-blacklist", GroupController::addGroupMemberBlacklist);
