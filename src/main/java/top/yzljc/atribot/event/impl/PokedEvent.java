...
import top.yzljc.atribot.chat.onebot.SendPoke;
 ...
 */
@Getter
public class PokedEvent extends Event {
    ...
    public PokedEvent(long time, long selfId, long targetId, long userId, long groupId) {
        this.time = time;
        this.selfId = selfId;
