...
import top.yzljc.atribot.function.impl.weather.WeatherDataService;
...
public final class WeatherCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        try {
            ...
            if (!generated.isError() && generated.url() != null) {
                qq.sendMessage(ImageComponent.imageOf(generated.url()));
                return true;
            }
            qq.sendMessage(generated.isError()
                    ? generated.errorMessage()
                    : "在总结群聊数据时出现错误：数据获取失败，请稍后重试。");
        } catch (Exception e) {
            if (loadingMessageId != null) qq.recall(loadingMessageId);
