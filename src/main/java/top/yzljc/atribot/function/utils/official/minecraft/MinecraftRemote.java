...
public class MinecraftRemote {
    ...
    private MinecraftRemote() {
        throw new UnsupportedOperationException();
    }

    // ==================== 对外 API ====================

    public static void connect(String serverId, String host, int port, String groupId, String rsaPublicKeyBase64) {
        disconnect();
        MinecraftRemote.serverId = serverId;
        MinecraftRemote.groupId = groupId;
        running = true;
    ...
    public static String sendCommand(String command) {
        ...
        synchronized (MinecraftRemote.class) {
