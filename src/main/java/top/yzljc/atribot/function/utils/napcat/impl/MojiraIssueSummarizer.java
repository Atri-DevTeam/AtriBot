package top.yzljc.atribot.function.utils.napcat.impl;
...
public class MojiraIssueSummarizer {
    ...
    public static String translate(String key, String summary, String description) {
        ...
        String userPrompt =
                ...
                "- 保留复现步骤的完整性\n" +
                "- 去掉无意义的空行和格式噪声，不需要生成markdown格式符\n" +
                "- 直接输出翻译结果，不要加任何前缀说明";

        try {
            String result = aiService.askWithSystemPrompt(AiProvider.PLAN_1, userPrompt, SYSTEM_PROMPT);
