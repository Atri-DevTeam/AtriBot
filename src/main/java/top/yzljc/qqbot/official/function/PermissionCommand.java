    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length < 1) {
            sender.replyText(label,
                    """
                            用法：
                            /permission setrole <userOpenId> <role>
                            /permission add <userOpenId> <permission1,permission2>
                            /permission remove <userOpenId> <permission1,permission2>
                            /permission query <userOpenId>
                            """);
            return true;
        }
        ...
        if (action.equalsIgnoreCase("setrole")) {
            ...
            if (args.length < 3) {
                sender.replyText(label,
                        "用法：/permission setrole <userOpenId> <role>");
                return true;
            }
        ...
        if (action.equalsIgnoreCase("add")) {
            ...
            if (args.length < 3) {
                sender.replyText(label,
                        "用法：/permission add <userOpenId> <permission1,permission2>");
                return true;
            }
        ...
        if (action.equalsIgnoreCase("remove")) {
            ...
            if (args.length < 3) {
                sender.replyText(label,
                        "用法：/permission remove <userOpenId> <permission1,permission2>");
                return true;
            }
